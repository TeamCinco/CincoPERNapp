...
import fetchFinancialStatement from './fetchFinanceData';
  ...
  const handleUserInputSubmit = async (ticker, statementType, frequency) => {
    ...
    if (financialStatementData) {
      ...
      const tableColumns = [
        ...
        ...dates.map((date, index) => ({ Header: date.formatted, accessor: `date_${index}` }))
      ];
